...
const mediaToolsData = [
    ...
    { title: "Copilot", desc: "infografika, obrázky, pozor na češtinu. Poslední dva obrázky z promptu.", links: [{ txt: "Copilot", url: "https://copilot.microsoft.com" }, { txt: "Prompty na obrázky", url: "../kapitoly/ukazky.html" }, { txt: "Tvorba jinak", url: "../kapitoly/ukazky.html#tab7" }], images: ["../img/cop_info_1.jpg", "../img/cop_info_2.jpg", "../img/ukazky/recept_copilot.jpg", "../img/ukazky/zdravi_3.jpg"] },
    { title: "Gemini", desc: "obrázky přesně dle popisu, skvělé infografiky z promptů.", links: [{ txt: "Google Gemini", url: "https://gemini.google.com" }, { txt: "Prompty na obrázky", url: "../kapitoly/ukazky.html" }, { txt: "Tvorba jinak", url: "../kapitoly/ukazky.html#tab7" }], images: ["../img//ukazky/coko_vyroba.jpg", "../img/zabava/gem_5.jpg", "../img/zabava/gem_4.jpg", "../img/zabava/gem_2.jpg", "../img/zabava/gem_3.jpg"]},
    { title: "ChatGPT", desc: "obrázky uzpůsobené stínováním, někdy domyšlené věci.", links: [{ txt: "OpenAI ChatGPT", url: "https://chat.openai.com" }, { txt: "Prompty na obrázky", url: "../kapitoly/ukazky.html" }, { txt: "Tvorba jinak", url: "../kapitoly/ukazky.html#tab7" }], images: ["../img//ukazky/recept_chatgpt.jpg", "../img/ukazky/zdravi_2.jpg", "../img/ukazky/dort_vrstvy.jpg", "../img/zabava/gpt_1.jpg", "../img/zabava/gpt_2.jpg",  "../img/zabava/gpt_3.jpg"]},
